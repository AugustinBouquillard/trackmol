...
The **trackmol** package offers a set of tools for manipulating, analyzing, and visualizing molecular trajectories. It is divided into several modules to cover different needs: data analysis, clustering, image processing using computer vision techniques, molecular trajectory generation, and various tools to facilitate the research and development workflow in computational biophysics.
